...
\cite{Larsen201428,lei2018moving,ward2018survey,cho2019toward}. However, we will focus on bioinspired approaches to this methodology; a non-afiliated
...
\begin{figure}[h!tb]
  ...
  \includegraphics[width=0.95\columnwidth]{results/chromosome-diagram.svg}
...
elements, the first of which is the fitness, and the second the a list
