...
\cite{erseco:evostar:anon}; nine of then are {\sf nginx} directives
...
content. In our previous paper \cite{erseco:evostar:anon}, a basic application was created, and
...
\begin{table}
\centering
\caption{Distribution of ZAP passive scanning scores. \label{table:fitness}}
...
\begin{figure*}[h!tb]
  ...
  \end{figure*}
%
As in our previous paper, \cite{erseco:evostar:anon}, we have designed the
