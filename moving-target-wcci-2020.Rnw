...
how the browser processes the received pages. They add up a subset of fifteen directives, that also matches a few of the  more extense DISA STIG recommendations
...
%
%
The {\sf nginx} directives that have been used here paper (as well as in \ref{erseco:evostar} and their equivalent STIG ID are shown in Table
