...
have used fifteen, the same as in the previous paper in this line of work
...
receiving the information behaves. This subset is extracted from the DISA STIG recommendations
