...
a good survey is made in \ref{Cai2016}. These techniques include
...
solutions using evolutionary algorithms were described for the first time by John et
al. \cite{john_evolutionary_2014}. This paper describes a host-level
...
level using the above mentioned CVSS score. 
More recently, Buji et al. in
