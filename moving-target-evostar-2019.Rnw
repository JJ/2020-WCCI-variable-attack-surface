...
For the 16 individuals population size the experiment took an average of 35 minutes, taking 80 minutes in the 32 individuals population size and 180 minutes for the 64 individuals population size. That's why we run each population size in a different machine. The running time of all instances was 266 hours, equivalent to 11 days of total processing time having a total cost of \$11.07.
