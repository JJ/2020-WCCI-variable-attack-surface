...
% Future work 
This project could be evolved by adding more {\sf nginx} directives as
well as more security-related HTTP headers. It could also be an
improvement try different HTTP servers such as Apache. 
