...
\begin{tabular}{|l|}
\hline
\textbf{Directive name} \\ \hline
worker\_connections            \\ \hline
keepalive\_timeout             \\ \hline
disable\_symlinks              \\ \hline
autoindex                      \\ \hline
send\_timeout                  \\ \hline
large\_client\_header\_buffers \\ \hline
client\_max\_body\_size        \\ \hline
server\_tokens                 \\ \hline
gzip                           \\ \hline
\end{tabular}
...
\begin{tabular}{|l|}
\hline
\textbf{Header name}           \\ \hline
X-Frame-Options                \\ \hline
X-Powered-By                   \\ \hline
X-Content-Type-Options         \\ \hline
Server                         \\ \hline
X-XSS-Protection	           \\ \hline
Content-Security-Policy		   \\ \hline
